...
export class VenueRuntime {
  ...
  async select(request: SelectGameRequest): Promise<Record<string, unknown>> {
  ...
  control(actionValue: unknown): Record<string, unknown> {
...
export function productionCatalog(): Array<Record<string, unknown>> {
