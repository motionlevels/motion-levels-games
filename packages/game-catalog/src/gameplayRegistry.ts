...
import { gameManifestSlug } from "@motion-levels-games/game-sdk";
import { buildGameplayRegistry, type GameplayModule } from "@motion-levels-games/runtime";

const registeredGames: readonly GameplayModule[] = [
...
/** Canonical identities plus unique mutable aliases accepted by product hosts. */
